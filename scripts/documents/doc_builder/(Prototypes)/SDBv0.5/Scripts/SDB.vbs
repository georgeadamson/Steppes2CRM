...
Function CheckError(strDescription, boolContinue)
	...
	If Err.Number <> 0 Then
		...
		If Not boolContinue Then
			...
			objTemplate.Save		 ' Close Word but do not use FinaliseDocument through risk of circular errors
			objTemplate.Close
			objWord.Quit
...
'	objWord.ScreenUpdating = False
	...
	CheckError "Unable to save template as running document", False
	...
	CheckError "Unable to replace document settings", False
