...
Gem::Specification.new do |s|
  ...
  s.date = "2010-03-22"
  s.description = "Merb plugin that supports controller action arguments"
  ...
  s.summary = "Merb plugin that provides support for named parameters in your controller actions"
