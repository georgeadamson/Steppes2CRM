 ...
 *
 * Tested in IE6, Opera9, Firefox 3.5-3.6
 * v1.0    11 Aug 2006 - George Adamson	- First release
 * v1.1       Aug 2006 - George Adamson	- Minor enhancements
 * v1.2    27 Sep 2006 - Mark Gibson		- Major enhancements
 * v1.3a   28 Sep 2006 - George Adamson	- Minor enhancements
 * v2.0	   20 Oct 2009 - George Adamson	- Major refactor with breaking changes to options.
 * v2.0.1  07 Jun 2010 - George Adamson	- Added support for number-pad keys (and KEY constant to make code more readable).
...
$.fn.spinbox = function(options){
	...
	// DESTROY: Tidy up when spinbox('destroy') is called:
	...
	return this.each(function(){
		...
		var hoverUp, hoverDown, delayId, repeatId, $box = $(this);
...
// Helper to make the 'keys' filter more readable:
// Keys can be matched using either regular expressions or char codes.
var KEY = $.fn.spinbox.KEY = {
...
// These defaults can be overridden by passing your own options hash when calling .spinbox(options):
$.fn.spinbox.defaults = {
	...
	keys			: [ KEY.digits, KEY.dot, KEY.minus, KEY.tab, KEY.enter, KEY.backspace, KEY.delete, KEY.pageUpDown, KEY.arrows ],	// Array of regular expressions and/or char codes to restrict key input. Default: 0-9, Tab, Enter, Backspace, Delete, PageUp, PageDown, Left, Up, Right, Down, Minus, Comma, Dot.
	...
	reset			: null,						// Value used when element value is invalid. Specify null to use the element's initial value;
	...
	scale			: true,						// Specify number of decimal places (DP), or true to auto derive from options.step (Eg: when step is 0.125 then DP will be 3)
	round			: function(num,dp) {		// Specify your own decimalPlaces rounding function if you don't like this default one.
