...
(function($) {
    $.fn.callout = function(settings) {
        ...
        // Changed by GA Sep 2009 to allow height to be specified. Was: settings.mainHeight = dummy.height() + settings.paddingTop + settings.paddingBottom + 2 * settings.borderWidth;
        settings.mainHeight = ( settings.height || dummy.height() ) + settings.paddingTop + settings.paddingBottom + 2 * settings.borderWidth;
